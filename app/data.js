...
export const solutionsSection = {
  title: "Beautifully Engineered Solutions",
  description: "Our innovative approach represents the perfect intersection of science and simplicity.",
  solutions: [
    {
      name: "Formulation Excellence",
      description:
        "Our proprietary formulation process combines 12 active ingredients to create powerful, multi-functional solutions.",
      image: "/images/product-serum.jpg",
    },
    {
      name: "Regenerative Technology",
      description:
        "Advanced cellular regeneration technology that works at the molecular level to transform skin health.",
      image: "/images/product-cream.jpg",
    },
    {
      name: "Clarity Complex",
      description:
        "A revolutionary approach to skin clarity that balances the microbiome while strengthening the skin barrier.",
...
export const testimonialsSection = {
  ...
  testimonials: [
    {
      quote:
        "Rebirth Labs has revolutionized our approach to skincare formulation. Their scientific expertise is unmatched in the industry.",
      author: "Emma S.",
      role: "Director of R&D, BeautyTech Inc.",
      image: "/images/testimonial-1.jpg",
    },
    {
      quote:
        "The innovative approach at Rebirth Labs has helped us create products that truly stand out in a crowded market.",
      author: "Michael T.",
      role: "CEO, Derma Solutions",
      image: "/images/testimonial-2.jpg",
    },
    {
      quote:
        "As a dermatologist, I'm impressed by the science-backed approach. Rebirth Labs is changing the future of skincare.",
...
export const contactSection = {
  ...
  socialMedia: [
    ...
    { platform: "LinkedIn", url: "https://linkedin.com/company/rebirthlabs", icon: "linkedin" },
  ],
}
